...
// ContentTransferEnd returns the duration of content transfer time.
...
func (r *Result) ContentTransferEnd(t time.Time) time.Duration {
	return t.Sub(r.serverDone)
}

// TotalEnd returns the duration of total http request.
...
func (r *Result) TotalEnd(t time.Time) time.Duration {
